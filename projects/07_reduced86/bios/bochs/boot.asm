...
GDT:    dw 0,      0,      0,     0      ; 00 NULL-дескриптор
        ...
        dw 0FFFFh, 0x8000, 9200h, 0000h  ; 10 16-битный дескриптор данных
        dw 0FFFFh, 0x0000, 9A00h, 000Fh  ; 18 16-битный временный код
        dw 0FFFFh, 0x0000, 9200h, 000Fh  ; 20 16-битный временные данные
